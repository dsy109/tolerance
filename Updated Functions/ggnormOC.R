      ...
      plot <- add_trace(plot,
        ...
        layout(
          legend = list(title=list(text=paste("P",sep="")),
                        ...
                        font = list(size=legend.size)),
          ### use html decimal code for greek letters. ###
          title = list(text = paste("Normal Tolerance Interval OC Curve for (1-",'&#945;',") (k=",k,")",
                                    sep=""),
                       x = title.position.x,
                       y = title.position.y,
                       font = list(size=title.size)),
      ...
      plot <- add_trace(plot,
        ...
        layout(
          legend = list(title=list(text=paste("(1-",'&#945;',",P)",sep="")),
                        ...
                        font = list(size=legend.size)),
          ### use html decimal code for greek letters. ###
          title = list(text = paste("Normal Tolerance Interval OC Curve for k and n",
                                    sep=""),
                       x = title.position.x,
                       y = title.position.y,
                       font = list(size=title.size)),
