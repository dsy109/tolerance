...
ggplottol.reg(tol.out = out1 , x=x , y=y , new.x = c(6,20), side = "two")
########################
set.seed(100)
x1 <- runif(100, 0, 10)
x2 <- rpois(100 , 5)
...
out2 <- regtol.int2(reg = lm(y ~ x1 + x2), new.x = cbind(x1.new , x2.new), new=TRUE,
                    side = 1, alpha = 0.05, P = 0.95)
ggplottol.reg(tol.out = out2 , y=y , x=cbind(x1,x2) , new.x = cbind(x1.new , x2.new) , 
              rect = TRUE , side = "two")
###########################
...
out1 <- nlregtol.int2(formula = formula,
                      ...
                      alpha = 0.05, P = 0.95)
ggplottol.reg(tol.out = out1 , x=x , y=y , new.x = c(20,50) , side = "two")
#########
set.seed(100)
x1 <- runif(50, 5, 45)
x2 <- rnorm(50, 0, 10)
...
out2 <- nlregtol.int2(formula = formula,
                      ...
                      alpha = 0.05, P = 0.95)
ggplottol.reg(tol.out = out2 , y=y , x=cbind(x1,x2) , 
...
ggplottol.reg(tol.out = out1 , x=x , y=y , side = "two")
############
set.seed(100)
x1 <- runif(50, 5, 45)
x2 <- rnorm(50 , 0 , 1)
